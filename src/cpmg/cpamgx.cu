...
pybind11::tuple
amgx_solve_diffusion_convection(
        const pybind11::array_t<bool> & boundaryMask,
...
)
{
    ...
    int n2 = assemble2DDiffusionConvectionProblem(
            boundaryMask, vx, vy, alpha, beta, laplacian, boundaryValue,
            val, col, ptr, rhs
    );
...
void init_py_module(pybind11::module_ & m)
{
    ...
    m.def("amgx_solve_diffusion_convection",
          amgx_solve_diffusion_convection,
          "boundary_mask"_a,
          "vx"_a,
          "vy"_a,
